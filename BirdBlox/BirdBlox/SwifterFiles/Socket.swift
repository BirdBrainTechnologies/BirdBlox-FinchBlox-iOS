...
open class Socket: Hashable, Equatable {
    ...
    public func port() throws -> in_port_t {
        ...
        return try withUnsafePointer(to: &addr) { pointer in
            ...
            #if os(Linux)
                return ntohs(oldAddr.sin_port)
            #else
                return Int(OSHostByteOrder()) != OSLittleEndian ? oldAddr.sin_port.littleEndian : oldAddr.sin_port.bigEndian
            #endif
        }
    }
    ...
    public func isIPv4() throws -> Bool {
        ...
        return try withUnsafePointer(to: &addr) { pointer in
            ...
            return Int32(oldAddr.sin_family) == AF_INET
        }
    }
